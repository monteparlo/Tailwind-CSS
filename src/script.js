function applyStyle(styleNumber) {
    ...
    switch(styleNumber) {
        ...
        case 4: 
            content.className = 's4 bg-[rgb(255,207,225)] w-full p-11 text-[rgb(48,0,0)] text-[45px] box-border font-impact text-center';
            break;
        ...
        case 5: 
            ...
            document.querySelectorAll("p").forEach(paragraph => {
                paragraph.className = 'bg-gray-800 p-4 rounded shadow-lg text-[1.2vw]';
            });
            break;
    }
}
